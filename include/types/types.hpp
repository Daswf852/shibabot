...
namespace Shiba {
    ...
    class User {
        public:
            ...
            virtual std::string GetUsername() const noexcept = 0;
            ...
            virtual std::string GetPingableUsername() const noexcept = 0;
            ...
            virtual bool GetBot() const noexcept = 0;
    };
    ...
    class Command {
        public:
            ...
            //3: bot half operator
            //4: bot operator
            virtual int GetPermLevel() const noexcept = 0;
    ...
    class CommandModule {
        public:
            ...
            void RegisterCommand(Command &command) noexcept {
            ...
            bool ContainsCommand(const std::string &command) const noexcept {
